                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="nip" placeholder="Tulis NIP Pegawai">
                    </div>
                    <div class="form-group">
                      <label for="nama">Nama</label>
                      <input type="text" class="form-control" id="nama" placeholder="Tulis Nama Pegawai">
                    </div>
                    <div class="form-group">
                      <label for="jabatan">Jabatan</label>
                      <input type="text" class="form-control" id="jabatan" placeholder="Tulis Jabatan Pegawai">
                    </div>
                    <div class="form-group">
                      <label for="pangkat">Pangkat</label>
                      <input type="text" class="form-control" id="pangkat" placeholder="Tulis Pangkat Pegawai">
                    </div>
                    <div class="form-group">
                      <label for="golongan">golongan</label>
                      <input type="text" class="form-control" id="golongan" placeholder="Tulis Golongan Pegawai">
                    </div>
                    <div>
